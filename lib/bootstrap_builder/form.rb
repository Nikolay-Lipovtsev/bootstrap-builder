  ...
  class FormBuilder < ActionView::Helpers::FormBuilder
    ...
    BASE_CONTROL_HELPERS.each do |helper|
      define_method(helper) do |method_name, *args|
        ...
        form_group_wrapper label, control, options
      end
    end
    ...
    CHECKBOX_AND_RADIO_HELPERS.each do |helper|
      ...
      define_method(helper) do |method_name, *args|
        ...
        form_group_wrapper form_group_label, control, options
      end
    end
    ...
    def button(content_or_options = nil, options = {}, &block)
      ...
      form_group_wrapper nil, control, options
    end
    ...
    def button_link(name = nil, options = {}, html_options = {}, &block)
      ...
      form_group_wrapper nil, control, html_options
    end
