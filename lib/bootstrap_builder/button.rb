module BootstrapBuilder
  ...
  module Button
    ...
    #      </div>
    #
    # bootstrap_button_tag("Test", col: 6, row_disabled: true)
    # # => <div class="col-sm-6">
    #        <button class="btn btn-default btn-block" name="button" type="submit">Test</button>
    #      </div>
    # 
    # bootstrap_button_tag("Test", offset_col: 6)
    # # => <div class="row">
    ...
    #      </div>
    #      
    def bootstrap_button_tag(content_or_options = nil, options = nil, &block)
    ...
    #      </div>
    #
    # bootstrap_button_link_tag("Test", new_user_path, col: 6, row_disabled: true)
    # # => <div class="col-sm-6">
    #        <a class="btn btn-default btn-block" href="/users/new" role="button">Test</a>
    #      </div>
    # 
    # bootstrap_button_link_tag("Test", new_user_path, offset_col: 6)
    # # => <div class="row">
    #        <div class="col-sm-offset-6">
    #          <a class="btn btn-default" href="/users/new" role="button">Test</a>
    #        </div>
    #      </div>
    #      
    def bootstrap_button_link_tag(name = nil, options = nil, html_options = {}, &block)
    ...
    #      </div>
    #
    # bootstrap_submit_tag("Test", col: 6, row_disabled: true)
    # # => <div class="col-sm-6">
    #        <input class="btn btn-default btn-block" name="commit" type="submit" value="Test">
    #      </div>
    # 
    # bootstrap_submit_tag("Test", offset_col: 6)
    # # => <div class="row">
    #        <div class="col-sm-offset-6">
    #          <input class="btn btn-default" name="commit" type="submit" value="Test">
    #        </div>
    #      </div>
    #
    def bootstrap_submit_tag(value = nil, options = nil)
      options ||= {}
      button_block(options) do
        options = base_button_class options
    ...
    #
    # === Examples
    # bootstrap_button_input_tag("Test")
    # # => <input class="btn btn-default" name="commit" type="button" value="Test">
    #
    # bootstrap_button_input_tag("Test", type: :button)
    # # => <input class="btn btn-default" name="commit" type="button" value="Test">
    #
    # bootstrap_button_input_tag("Test", style: :primary)
    # # => <input class="btn btn-primary" name="commit" type="button" value="Test">
    #
    # bootstrap_button_input_tag("Test", size: :lg)
    # # => <input class="btn btn-default btn-lg" name="commit" type="button" value="Test">
    #
    # bootstrap_button_input_tag("Test", active: true)
    # # => <input class="btn btn-default active" name="commit" type="button" value="Test">
    #
    # bootstrap_button_input_tag("Test", disabled: true)
    # # => <input class="btn btn-default" disabled="disabled" name="commit" type="button" value="Test">
    #
    # bootstrap_button_input_tag("Test", col: 6)
    # # => <div class="row">
    #        <div class="col-sm-6">
    ...
    #      </div>
    #
    # bootstrap_button_input_tag("Test", col: 6, row_disabled: true)
    # # => <div class="col-sm-6">
    #        <input class="btn btn-default btn-block" name="commit" type="button" value="Test">
    #      </div>
    # 
    # bootstrap_button_input_tag("Test", offset_col: 6)
    # # => <div class="row">
    #        <div class="col-sm-offset-6">
    #          <input class="btn btn-default" name="commit" type="button" value="Test">
    #        </div>
    #      </div>
    #
    def bootstrap_button_input_tag(value = nil, options = nil)
      options ||= {}
      options[:type] = :button
